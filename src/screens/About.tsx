...
const desktopView = (
  ...
  <img className='h-[600px]  mb-0 h-w-full' src="src/assets/portada2.png" alt="Portada" />
</section>
...
const mobileView =(
    <section className="grid grid-rows-2 lg:grid-cols-2 lg:h-screen">
      <section className="bg-pinkbg lg:row-auto lg:col-span-1 flex items-end justify-center lg:justify-end">
        <img className='lg:h-[600px] lg:w-auto w-auto h-80 justify-end items-end' src="src/assets/portada2.png" alt="Portada" />
      </section>
